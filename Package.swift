...
let package = Package(name: "VLCalendarKit",
                      platforms: [ .iOS(.v17) ],
                      products:
                      [
                       .library(name: "VLCalendarKit",
                      ...
                      targets:
                      [
                       .target(name: "VLCalendarKit",
                               dependencies: [ "VLDateKit", "VLViewKit" ]),
                       .testTarget(name: "VLCalendarKitTests",
